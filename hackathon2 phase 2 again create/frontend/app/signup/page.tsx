  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-900 via-blue-800 to-slate-900 px-4 py-8 relative overflow-hidden">
      ...
      <div className="w-full max-w-md relative z-10">
        <div className="bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 rounded-2xl shadow-2xl overflow-hidden backdrop-blur-xl border border-gray-700 animate-fadeIn">
          ...
          <div className="bg-gradient-to-r from-blue-600 to-blue-700 px-8 py-12 relative overflow-hidden">
            ...
            <div className="relative z-10">
              <h1 className="text-4xl font-bold text-white mb-2 animate-slideUp">Get Started</h1>
              <p className="text-blue-100 animate-slideUp animation-delay-100">Create your account to start managing tasks</p>
            </div>
          </div>
          ...
          <div className="px-8 py-8">
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <button
                type="submit"
                disabled={loading}
                className="w-full bg-gradient-to-r from-blue-600 to-blue-700 text-white font-semibold py-3 px-4 rounded-lg hover:from-blue-700 hover:to-blue-800 transition transform hover:scale-105 disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:scale-100 mt-8 animate-slideUp animation-delay-500"
              >
                {loading ? (
            ...
            <div className="mt-8 pt-6 border-t border-gray-700 animate-slideUp animation-delay-600">
              <p className="text-center text-gray-400 text-sm">
                Already have an account?{' '}
                <a href="/signin" className="text-blue-400 font-semibold hover:text-blue-300 transition">
                  Sign in
                </a>
              </p>
            </div>
        ...
        {/* Footer */}
        <p className="text-center text-gray-500 text-xs mt-8 animate-fadeIn animation-delay-700">
